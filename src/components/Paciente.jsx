  ...
  return (
    <div className="mx-5 my-10 bg-white shadow-md px-5 py-10 rounded-xl">
      ...
      <div className="flex justify-between mt-10">
        ...
        font-bold uppercase rounded-lg" onClick={()=> setPaciente(paciente)}>Editar</button> {/* se usa arrow function debido a que se le esta pasando un parametro de lo contrario se pondria la funcion sin parentesis y sin arrow function para que no se ejecute hasta que le unda editar*/}
        <button type="button" className="py-2 px-10 bg-red-600 hover:bg-red-700 text-white
        font-bold uppercase rounded-lg" onClick={handleEliminar}>Eliminar</button>
      </div>
    </div>
  );
};
